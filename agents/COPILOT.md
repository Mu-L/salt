...
pip install -r requirements/static/pkg/py3.10/linux.lock  # or darwin.in/windows.in
...
pip install --upgrade pip setuptools wheel
pip install -r requirements/static/pkg/py3.11/linux.lock  # or darwin.in/windows.in
